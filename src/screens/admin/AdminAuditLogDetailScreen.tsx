...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: Fonts.size.md, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary, marginBottom: Spacing.sm },
  detailRow: {
    flexDirection: 'row',
  ...
  detailValue: { fontSize: Fonts.size.sm, fontFamily: Fonts.semibold, fontWeight: '600', color: Colors.textPrimary, flex: 2, textAlign: 'right' },
  changeRow: {
    paddingVertical: Spacing.sm,
    borderBottomWidth: 1,
    borderBottomColor: Colors.border,
  },
  changeField: { fontSize: Fonts.size.sm, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary, marginBottom: Spacing.xs },
  ...
  valueBool: { fontFamily: Fonts.semibold, fontWeight: '600' },
  valueNumber: { color: Colors.bordeaux, fontFamily: Fonts.semibold, fontWeight: '600' },
  ...
  retryText: { color: Colors.bordeaux, fontFamily: Fonts.semibold, fontWeight: '600', fontSize: Fonts.size.md },
});