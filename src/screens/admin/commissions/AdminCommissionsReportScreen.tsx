...
const styles = StyleSheet.create({
  ...
  summaryAmount: { fontSize: 38, fontFamily: Fonts.bold, fontWeight: '900', color: Colors.white, marginVertical: Spacing.xs },
  summaryStats: { flexDirection: 'row', justifyContent: 'space-around', marginTop: Spacing.sm },
  statItem: { alignItems: 'center' },
  statValue: { fontSize: Fonts.size.md, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.white },
  ...
  historyTitle: { fontSize: Fonts.size.xl, fontFamily: Fonts.bold, fontWeight: '800', color: Colors.bordeaux, marginBottom: Spacing.sm },
  ...
  rateBadge: { fontSize: Fonts.size.xs, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.bordeaux },
  ...
  amountValue: { fontSize: Fonts.size.sm, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary, marginTop: 2 },
