...
const fld = StyleSheet.create({
  ...
  label:     { fontSize: Fonts.size.sm, color: Colors.textSecondary, marginBottom: 4, fontFamily: Fonts.medium, fontWeight: '500' },
...
const card = StyleSheet.create({
  ...
  info:            { flex: 1 },
  label:           { fontSize: Fonts.size.lg, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary },
  ...
  btnEditText:     { fontSize: Fonts.size.sm, color: Colors.bordeaux, fontFamily: Fonts.semibold, fontWeight: '600' },
  btnToggle:       { borderColor: Colors.border },
  btnToggleText:   { fontSize: Fonts.size.sm, color: Colors.textSecondary, fontFamily: Fonts.semibold, fontWeight: '600' },
  btnDelete:       { borderColor: Colors.errorLight, backgroundColor: Colors.errorLight },
  btnDeleteText:   { fontSize: Fonts.size.sm, color: Colors.error, fontFamily: Fonts.semibold, fontWeight: '600' },
});
...
const modal = StyleSheet.create({
  ...
  title:       { fontSize: Fonts.size.lg, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary },
  ...
  switchLabel: { fontSize: Fonts.size.md, color: Colors.textPrimary, fontFamily: Fonts.medium, fontWeight: '500' },
  ...
  btnSaveText: { fontSize: Fonts.size.md, color: Colors.white, fontFamily: Fonts.bold, fontWeight: '700' },
...
const s = StyleSheet.create({
  ...
  pageTitle:   { fontSize: Fonts.size.xl, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary },
  ...
  retryText:   { fontSize: Fonts.size.sm, color: Colors.bordeaux, fontFamily: Fonts.semibold, fontWeight: '600', textDecorationLine: 'underline' },
  ...
  emptyBtnText:{ fontSize: Fonts.size.md, color: Colors.white, fontFamily: Fonts.semibold, fontWeight: '600' },
  list:        { flex: 1 },
