...
const styles = StyleSheet.create({
  ...
  ttcLabel: { fontSize: Fonts.size.sm, fontFamily: Fonts.bold, fontWeight: '700', color: Colors.textPrimary },
  ttcValue: { fontSize: Fonts.size.md, fontFamily: Fonts.bold, fontWeight: '800', color: Colors.bordeaux },
  pdfBtn: {
