...
export default function DriverProfileScreen({ navigation }: Props) {
  const { user, logout, changePassword, isLoading, error, clearError, login, updateProfile, uploadAvatar } = useDriver();
  ...
  const [vtc_license, setVtc_license]     = useState(user?.vtc_license ?? '');
  ...
  const handleEditToggle = React.useCallback(async () => {
    if (editMode) {
      try {
        await updateProfile({ first_name: firstName, last_name: lastName, phone, iban , vtc_license, vehicle_type: vehicle, });        
  ...
  }, [editMode, firstName, lastName, phone, pendingImage, confirmedImage, vtc_license, iban, vehicle, updateProfile, uploadAvatar]);
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formSection}>
          <View style={styles.formSectionContainer}>
            ...
            <ProfileField label="Numéro de licence VTC" value={vtc_license} editable={editMode}  onChangeText={setVtc_license}/>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionContainer}>
            ...
            <ProfileField label="IBAN" value={iban} editable={editMode} onChangeText={setIban} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionContainer}>
            ...
            <ProfileField label="Type" value={vehicle}  editable={editMode} onChangeText={setVehicle}/>
          </View>
        </View>
        ...
        <View style={styles.actionsSection}>
          ...
          <TouchableOpacity style={styles.actionRow} onPress={() => navigation.navigate('DriverDocuments')}>
