...
const styles = StyleSheet.create({
  ...
  sectionTitle:     { fontSize: Fonts.size.md, fontFamily: Fonts.bold, fontWeight: '800', color: Colors.bordeaux },
  ...
  addLink:          { color: Colors.bordeaux, fontFamily: Fonts.semibold, fontWeight: '600', fontSize: Fonts.size.sm },
  ...
  actionLabel:    { fontSize: Fonts.size.md, fontFamily: Fonts.medium, fontWeight: '500' },
...
const modalStyles = StyleSheet.create({
  ...
  typeBtnTextActive:    { color: Colors.bordeaux, fontFamily: Fonts.bold, fontWeight: '700' },
