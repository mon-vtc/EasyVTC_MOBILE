          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
              ...
              <View style={styles.row}>
                <View style={styles.half}>
                  <FormField<FormData>
                    ...
                    testID="register-driver-firstname-input"
                  />
                </View>
                <View style={[styles.half, { marginLeft: Spacing.sm }]}>
                  <FormField<FormData>
                    ...
                    testID="register-driver-lastname-input"
                  />
                </View>
              </View>
              ...
              <FormField<FormData>
                ...
                testID="register-driver-phone-input"
              />
              ...
              <FormField<FormData>
                ...
                testID="register-driver-email-input"
              />
              ...
              <FormField<FormData>
                ...
                testID="register-driver-password-input"
              />
              ...
              <AppButton
                ...
                size="lg"
                style={styles.button}
                testID="register-driver-submit-btn"
              />
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  signInWithGoogle({ intent: 'register', role: 'driver', accept_terms: true });
                }}
                disabled={anyLoading}
              >
                {googleLoading ? (
