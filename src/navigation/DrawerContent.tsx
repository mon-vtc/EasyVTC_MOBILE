...
const styles = StyleSheet.create({
  ...
  avatarText:      { color: Colors.placeHolder, fontSize: Fonts.size.xl, fontFamily: Fonts.bold, fontWeight: '800' },
  name:            { color: Colors.white, fontSize: Fonts.size.lg, fontFamily: Fonts.bold, fontWeight: '700' },
  ...
  labelText:       { fontSize: 16, color: Colors.textPrimary, fontFamily: Fonts.medium, fontWeight: '500', flex: 1, marginLeft: 8 },
  ...
  subItemLabel:    { fontSize: 15, color: Colors.textPrimary, fontFamily: Fonts.medium, fontWeight: '500' },
  badge: {
    width: 10,
    height: 10,
    borderRadius: 5,
